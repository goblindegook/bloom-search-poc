 ...
 *
 */
elasticlunr.Index.prototype.fieldSearchStats = function (
  docTokens,
  token,
  docs
) {
 ...
 */
elasticlunr.DocumentStore.prototype.getFieldLength = function (
  docRef,
  fieldName
) {
 ...
 */
elasticlunr.InvertedIndex.prototype.addToken = function (
  token,
  tokenInfo,
  root
) {
 ...
 * @memberOf InvertedIndex
 */
elasticlunr.InvertedIndex.prototype.getTermFrequency = function (
  token,
  docRef
) {
  var node = this.getNode(token)
 ...
 * @param {Array} fields fields of index instance
 */
elasticlunr.Configuration.prototype.buildUserConfig = function (
  config,
  fields
) {
  var global_bool = 'OR'
